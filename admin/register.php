...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($numRows > 0) {
        ...
        if ($pass == $cpass) {
            ...
            $sql = "INSERT INTO `admin` (`username`,`password`,`name`,`created`) VALUES ('$username','$hash','$name',current_timestamp())";
...
<div class="register-box">
  <div class="card card-outline card-primary">
    ...
    <div class="card-body">
      <p class="login-box-msg">Register for admin panel</p>
      ...
      <form action="register.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="University Roll No" name="username" id="username">
          <div class="input-group-append">
            <div class="input-group-text">
